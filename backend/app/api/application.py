...
from app.database import get_db, Server, Application, User, Account
...
def submit_application(
    ...
    if user.is_admin and app_in.uid is not None:
        ...
        return JSONResponse(
            content={
                ...
                "create_date": new_acc.create_date.isoformat()
            },
...
def approve_application(
    ...
    db.add(acct); db.delete(app); db.commit()
